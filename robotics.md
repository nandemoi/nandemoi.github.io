...
"mega.nz download” → Desktop Apps: Raspbian 10 (32 bits), apt install gdebi, sudo gdebi …
   1. apt install code (python, verilog <img src="https://camo.githubusercontent.com/..." data-canonical-src="https://i.imgur.com/3a5QbtN.png" width="20" height="20")![](https://i.imgur.com/2zUvdSz.png =20x20), teros, wavetrace), iverilog, yosys
